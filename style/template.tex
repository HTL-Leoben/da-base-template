...
% Compatibility with modern pandoc citeproc output (>= 3.1.7)
% Pandoc emits \citeproc{id}{label}, these macros must exist in the preamble
...
\newenvironment{CSLReferences}[2] % #1 hanging-indent, #2 entry spacing
  {\setlength{\parindent}{0pt}%
   ...
   % Pandoc emits \bibitem, register cites without requiring a list environment
   \def\@lbibitem[##1]##2{%
     \if@filesw
       {\let\protect\noexpand
